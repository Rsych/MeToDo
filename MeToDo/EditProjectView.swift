...
struct EditProjectView: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $showingDeleteConfirm) {
            Alert(title: Text("Delete project?"), message: Text("Are you sure you want to delete this project? You will lose all the items inside."), primaryButton: .default(Text("Delete"), action: delete), secondaryButton: .cancel())
        }
    }  //: body
